"""
Converts the BIDS-structured MP2RAGE dataset to the nnUNetv2 dataset format. 
Full details about the format can be found here: https://github.com/MIC-DKFZ/nnUNet/blob/master/documentation/dataset_format.md
Currently supports for different sessions 
Usage example:
